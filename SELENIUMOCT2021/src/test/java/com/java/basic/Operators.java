...
/*si se se espera que todos sean true se puede enviar solo  if (isdog || iscat)
 *si se se espera que todos sean false se puede enviar solo  if (!isdog || !iscat) 
 */
