...
public class Tc001 {
	...
	public void tc001() {
		...
		//ruta en donde esta ubicado el driver de chrome
	...
	public void tc002() {
		...
		// Step 1 Launch browser //abrir / cargar el driver
		Reporter.log("Step 1 Launch browser");
		System.setProperty("webdriver.chrome.driver", "./src/test/resources/drivers/chrome/chromedriver.exe");
		driver = new ChromeDriver();
		//ingresar a la pag a probar
		driver.get("https://opensource-demo.orangehrmlive.com");
		driver.manage().window().maximize();
		...
		Assert.assertEquals(mensaje, "Credenciales no válidas");
		driver.close();
